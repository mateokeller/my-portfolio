      ...
      <div className="about-me-container">
        ...
        <div className="section-content">
          ...
          <p className="about-me-text">
            ...
            critical thinking and problem-solving strategies to complex
            projects. I'm also working on several projects at a time in order to
            learn more front-end development. <br />
          </p>
        </div>
      </div>
